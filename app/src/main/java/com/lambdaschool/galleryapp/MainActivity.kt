...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val views = mutableListOf<ImageView>()
            ...
            views[0].contentDescription = getString(R.string.abstract_art)
            ...
            views[1].contentDescription = getString(R.string.automobile)
            ...
            views[2].contentDescription = getString(R.string.aerial)
            ...
            views[3].contentDescription = getString(R.string.alley)
            ...
            views[4].contentDescription = getString(R.string.bridge)
            ...
            views[7].contentDescription = getString(R.string.colors)
            ...
            views[9].contentDescription = getString(R.string.astrophotography)
